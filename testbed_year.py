...
class WPD(Dataset):
	...
	def __getitem__(self, idx):
		...
		weather_data= np.zeros([1440, 16])	# hard coding for 1 day, 15 features & time
...
weather_list=[]
folders = glob.glob('ASOS_gwd_2022_data/*')
for folder in folders:
    weather_list.extend(glob.glob(f'{folder}/*'))
